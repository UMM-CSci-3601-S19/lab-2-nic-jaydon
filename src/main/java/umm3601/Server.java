...
public class Server {
  ...
  public static void main(String[] args) {
    ...
    // Get specific todo
    get("api/todos/:owner", todoController::getTodoOwner);
    get("api/todos/:category", todoController::getTodoCategory);
  ...
  private static UserController buildUserController() {
    ...
    try {
      userDatabase = new Database(USER_DATA_FILE,TODO_DATA_FILE);
  ...
  private static TodoController buildTodoController() {
    ...
    try {
      todoDatabase = new Database(USER_DATA_FILE,TODO_DATA_FILE);
